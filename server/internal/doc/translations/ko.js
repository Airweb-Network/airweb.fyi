...
`,
  ...
  // ---------- credits ----------
  'credits.title': '크레딧, 결제, 그리고 AWC 경제',
  'credits.description':
    '크레딧(AWC)은 AirWeb 안에서의 가치 단위입니다 — 핸들 임대, ' +
    '프리미엄 서브도메인, 크리에이터 후원에 쓰입니다. 경제가 어떻게 ' +
    '돌아가는지, 어떻게 충전하는지 알아보세요.',
  'credits.html': `
<h1>크레딧과 결제</h1>
<p class="lead">AirWeb 내부에서 가격이 있는 모든 것은
<strong>AirWeb 크레딧(AWC)</strong>으로 표시됩니다. 단순한 내부 회계 단위이며 —
블록체인은 관여하지 않습니다.</p>
...
<ol>
  ...
  <li><em>판매 등록</em>을 클릭하고 AWC 단위로 가격을 설정하세요.</li>

...
(function () {
  ...
  const LANDING_OVERRIDES = {
    es: {
      ...
      'the public internet': 'internet público',
      ...
      'Open the ': 'Abre el ',
      ', click ': ', haz clic en ',
      ', and save the downloaded ': ', y guarda el archivo descargado ',
      '. Your Ed25519 key ': '. Tu clave Ed25519 ',
      ...
      'HTTP tunnels get a ': 'Los túneles HTTP reciben una URL ',
      ...
      'public traffic': 'tráfico público',
      'net = earn − charge': 'neto = ingreso − cargo',
      'Uptime reward while your tunnel is online': 'Recompensa por tiempo en línea mientras tu túnel está activo',
      'Earned automatically while your tunnel stays online': 'Se gana automáticamente mientras tu túnel siga en línea',
      'Earned when someone leases your tunnel': 'Lo ganas cuando alguien alquila tu túnel',
      ...
      'List your spare-device tunnel, set a price per minute, and watch the leases come in. Browse what others offer and rent the right region or hardware for the job.':
        'Publica el túnel de tu equipo libre, ponle precio por minuto y deja que lleguen los alquileres. Mira lo que ofrecen otras personas y alquila la región o el hardware que te convenga.',
      'Reach any region': 'Llega a la región que necesitas',
      'Hosts on the marketplace are spread across home connections in many cities. Rent a node where your users actually are.':
        'Los hosts del mercado están repartidos entre conexiones domésticas en muchas ciudades. Alquila un nodo donde realmente están tus usuarios.',
      ...
      'Three logos own most of the public internet. Capacity = a credit card, a console, and a single-vendor lock-in.':
        'Tres logos controlan buena parte del internet público. Capacidad = tarjeta, consola y dependencia de un solo proveedor.',
      'Always-on fleets that idle most of the day': 'Flotas siempre encendidas que pasan medio día ociosas',
      'Embodied carbon poured into new hardware': 'Carbono incorporado volcado en hardware nuevo',
      'One vendor, one bill, one outage radius': 'Un proveedor, una factura, un mismo radio de caída',
      '~3 vendors': '~3 proveedores',
      'tomorrow': 'mañana',
      'A federated, people-powered cloud': 'Una nube federada y hecha por la gente',
      'Capacity = whatever\'s plugged in around the world right now. Owned by the people who paid for it, traded peer-to-peer.':
        'La capacidad es lo que esté enchufado en el mundo en este momento. La poseen quienes ya la pagaron y se intercambia entre pares.',
      'Reuses devices that already exist': 'Reutiliza dispositivos que ya existen',
      'Capacity scales with how many people show up': 'La capacidad escala con cuánta gente participa',
      ...
      'No fleet to provision — capacity is hardware that already exists': 'No hay flota que aprovisionar: la capacidad es hardware que ya existe',
      'No new fleet to provision; capacity comes from hardware already out there': 'No hay que aprovisionar una flota nueva; la capacidad sale del hardware que ya existe',
      'idle': 'en reposo',
      'Idle tunnels just sit on an SSH socket; no overhead farm': 'Un túnel inactivo sólo queda sobre un socket SSH; no hace falta una granja extra',
      'Idle tunnels just sit on an SSH socket; no idle server farm behind them': 'Los túneles inactivos sólo quedan sobre un socket SSH; no hay una granja de servidores ociosos detrás',
      'life': 'segunda vida',
      'Old laptops, phones, and Pis become useful instead of e-waste': 'Laptops viejas, teléfonos y Raspberry Pi vuelven a servir en vez de ser chatarra electrónica',
      'Old laptops, phones, and Pis go back to work instead of becoming e-waste': 'Laptops viejas, teléfonos y Raspberry Pi vuelven al trabajo en vez de convertirse en chatarra electrónica',
      'Capacity appears when devices are plugged in and disappears when they\'re not.': 'La capacidad aparece cuando los equipos se enchufan y desaparece cuando no.',
      'Smaller fleet → less embodied carbon, less e-waste, less drain on the grid.': 'Menos flota → menos carbono incorporado, menos basura electrónica y menos carga para la red.',
      'copy': 'copiar',
      'ok': 'listo',
      'fail': 'falló'
    },
    fr: {
      ...
      'the public internet': 'internet public',
      ...
      'Open the ': 'Ouvrez le ',
      ', click ': ', cliquez sur ',
      ', and save the downloaded ': ', puis enregistrez le fichier téléchargé ',
      '. Your Ed25519 key ': '. Votre clé Ed25519 ',
      ...
      'HTTP tunnels get a ': 'Les tunnels HTTP reçoivent une URL ',
      '; raw TCP tunnels get ': ' ; les tunnels TCP bruts reçoivent ',
      '. Every minute it stays up, you earn ': '. Chaque minute où il reste en ligne vous rapporte ',
      '. List it on the marketplace to earn lease income on top.': '. Publiez-le sur la place de marché pour ajouter des revenus de location.',
      'What you can do with it': 'Ce que vous pouvez en faire',
      'No subscriptions. No "free tier" cliffs. Opening a tunnel is free — you\'re billed in credits only for the bytes that actually flow through it, and you earn credits every minute your own devices are serving traffic.':
        'Pas d\'abonnement. Pas de faux plafond de "free tier". Ouvrir un tunnel est gratuit : vous ne payez en crédits que les octets qui passent vraiment, et vous gagnez des crédits chaque minute où vos propres appareils servent du trafic.',
      'your device': 'votre appareil',
      'public traffic': 'trafic public',
      'net = earn − charge': 'net = gain − coût',
      'Uptime reward while your tunnel is online': 'Récompense d\'uptime tant que votre tunnel reste en ligne',
      'Earned automatically while your tunnel stays online': 'Gagné automatiquement tant que votre tunnel reste en ligne',
      'Earned when someone leases your tunnel': 'Gagné quand quelqu\'un loue votre tunnel',
      ...
      'List your spare-device tunnel, set a price per minute, and watch the leases come in. Browse what others offer and rent the right region or hardware for the job.':
        'Publiez le tunnel de votre appareil disponible, fixez un prix à la minute et regardez les locations arriver. Parcourez les offres des autres et louez la bonne région ou le bon matériel selon le besoin.',
      'Reach any region': 'Touchez la bonne région',
      'Hosts on the marketplace are spread across home connections in many cities. Rent a node where your users actually are.':
        'Les hôtes du marché sont répartis sur des connexions domestiques dans de nombreuses villes. Louez un nœud là où se trouvent vraiment vos utilisateurs.',
      ...
      'Three logos own most of the public internet. Capacity = a credit card, a console, and a single-vendor lock-in.':
        'Trois logos tiennent l\'essentiel de l\'internet public. Capacité = carte bancaire, console d\'admin et dépendance à un seul fournisseur.',
      'Always-on fleets that idle most of the day': 'Des flottes toujours allumées qui tournent à vide la moitié du temps',
      'Embodied carbon poured into new hardware': 'Du carbone embarqué injecté dans du matériel neuf',
      'One vendor, one bill, one outage radius': 'Un fournisseur, une facture, un même rayon de panne',
      '~3 vendors': '~3 fournisseurs',
      'tomorrow': 'demain',
      'A federated, people-powered cloud': 'Un cloud fédéré porté par les gens',
      'Capacity = whatever\'s plugged in around the world right now. Owned by the people who paid for it, traded peer-to-peer.':
        'La capacité, c\'est ce qui est branché quelque part dans le monde à cet instant. Elle appartient à ceux qui l\'ont payée et s\'échange de pair à pair.',
      'Reuses devices that already exist': 'Réutilise des appareils déjà là',
      'Capacity scales with how many people show up': 'La capacité grandit avec le nombre de participants',
      ...
      'No fleet to provision — capacity is hardware that already exists': 'Aucune flotte à provisionner : la capacité, c\'est du matériel déjà existant',
      'No new fleet to provision; capacity comes from hardware already out there': 'Pas de nouvelle flotte à provisionner : la capacité vient du matériel déjà là',
      'idle': 'au repos',
      'Idle tunnels just sit on an SSH socket; no overhead farm': 'Un tunnel inactif reste simplement sur une socket SSH ; pas besoin d\'une ferme en surcouche',
      'Idle tunnels just sit on an SSH socket; no idle server farm behind them': 'Un tunnel inactif reste posé sur une socket SSH ; pas de ferme de serveurs au repos derrière',
      'life': 'seconde vie',
      'Old laptops, phones, and Pis become useful instead of e-waste': 'Les vieux portables, téléphones et Raspberry Pi redeviennent utiles au lieu de finir en déchets électroniques',
      'Old laptops, phones, and Pis go back to work instead of becoming e-waste': 'Les vieux portables, téléphones et Raspberry Pi repartent au travail au lieu de devenir des déchets électroniques',
      'Capacity appears when devices are plugged in and disappears when they\'re not.': 'La capacité apparaît quand les appareils sont branchés et disparaît quand ils ne le sont pas.',
      'Smaller fleet → less embodied carbon, less e-waste, less drain on the grid.': 'Moins de flotte → moins de carbone embarqué, moins de déchets électroniques, moins de pression sur le réseau.',
      'copy': 'copier',
      'fail': 'échec'
    },
    de: {
      ...
      'the public internet': 'das öffentliche Internet',
      ...
      'Open the ': 'Öffne das ',
      ', click ': ', klick auf ',
      ', and save the downloaded ': ', und speichere die heruntergeladene ',
      '. Your Ed25519 key ': '. Dein Ed25519-Schlüssel ',
      ...
      'HTTP tunnels get a ': 'HTTP-Tunnel bekommen eine URL ',
      '; raw TCP tunnels get ': '; Raw-TCP-Tunnel bekommen ',
      '. Every minute it stays up, you earn ': '. Für jede Minute Laufzeit bekommst du ',
      '. List it on the marketplace to earn lease income on top.': '. Stell es zusätzlich auf den Marktplatz und verdiene an Vermietungen mit.',
      'What you can do with it': 'Was du damit machen kannst',
      'No subscriptions. No "free tier" cliffs. Opening a tunnel is free — you\'re billed in credits only for the bytes that actually flow through it, and you earn credits every minute your own devices are serving traffic.':
        'Keine Abos. Keine "Free-Tier"-Falle. Einen Tunnel zu öffnen kostet nichts — berechnet werden nur die Bytes, die wirklich durchlaufen, und du verdienst Credits für jede Minute, in der deine eigenen Geräte Traffic bedienen.',
      'your device': 'dein Gerät',
      'public traffic': 'öffentlicher Traffic',
      'net = earn − charge': 'netto = einnahme − kosten',
      'Uptime reward while your tunnel is online': 'Uptime-Belohnung, solange dein Tunnel online ist',
      'Earned automatically while your tunnel stays online': 'Läuft automatisch auf, solange dein Tunnel online bleibt',
      'Earned when someone leases your tunnel': 'Verdienst, wenn jemand deinen Tunnel mietet',
      ...
      'List your spare-device tunnel, set a price per minute, and watch the leases come in. Browse what others offer and rent the right region or hardware for the job.':
        'Stell den Tunnel deines freien Geräts ein, leg einen Minutenpreis fest und sieh zu, wie Vermietungen reinkommen. Schau dir an, was andere anbieten, und miete die passende Region oder Hardware für deinen Job.',
      'Reach any region': 'Erreiche jede Region',
      'Hosts on the marketplace are spread across home connections in many cities. Rent a node where your users actually are.':
        'Hosts im Marktplatz sind über Heimanschlüsse in vielen Städten verteilt. Miete einen Knoten dort, wo deine Nutzer tatsächlich sind.',
      ...
      'Three logos own most of the public internet. Capacity = a credit card, a console, and a single-vendor lock-in.':
        'Drei Logos kontrollieren den Großteil des öffentlichen Internets. Kapazität heißt heute: Kreditkarte, Konsole und Lock-in bei einem Anbieter.',
      'Always-on fleets that idle most of the day': 'Immer laufende Flotten, die den Großteil des Tages untätig sind',
      'Embodied carbon poured into new hardware': 'Gebundener Kohlenstoff, der in neue Hardware fließt',
      'One vendor, one bill, one outage radius': 'Ein Anbieter, eine Rechnung, ein gemeinsamer Ausfallradius',
      '~3 vendors': '~3 Anbieter',
      'tomorrow': 'morgen',
      'A federated, people-powered cloud': 'Eine föderierte Cloud von Menschen für Menschen',
      'Capacity = whatever\'s plugged in around the world right now. Owned by the people who paid for it, traded peer-to-peer.':
        'Kapazität ist einfach das, was gerade irgendwo auf der Welt eingesteckt ist. Es gehört den Leuten, die es bezahlt haben, und wird direkt untereinander gehandelt.',
      'Reuses devices that already exist': 'Nutzt Geräte weiter, die schon da sind',
      'Capacity scales with how many people show up': 'Kapazität wächst mit der Zahl der Teilnehmenden',
      ...
      'new servers': 'neue Server',
      'No fleet to provision — capacity is hardware that already exists': 'Keine Flotte zum Provisionieren — die Kapazität ist Hardware, die schon existiert',
      'No new fleet to provision; capacity comes from hardware already out there': 'Keine neue Flotte zum Provisionieren; die Kapazität kommt aus Hardware, die längst da ist',
      'idle': 'idle',
      'Idle tunnels just sit on an SSH socket; no overhead farm': 'Ein inaktiver Tunnel hängt einfach nur an einem SSH-Socket; keine Overhead-Farm nötig',
      'Idle tunnels just sit on an SSH socket; no idle server farm behind them': 'Inaktive Tunnel hängen nur an einem SSH-Socket; keine untätige Serverfarm dahinter',
      'life': 'zweites Leben',
      'Old laptops, phones, and Pis become useful instead of e-waste': 'Alte Laptops, Handys und Pis werden wieder nützlich statt Elektroschrott',
      'Old laptops, phones, and Pis go back to work instead of becoming e-waste': 'Alte Laptops, Handys und Pis gehen wieder an die Arbeit, statt Elektroschrott zu werden',
      'Capacity appears when devices are plugged in and disappears when they\'re not.': 'Kapazität taucht auf, wenn Geräte eingesteckt sind, und verschwindet wieder, wenn sie es nicht sind.',
      'Smaller fleet → less embodied carbon, less e-waste, less drain on the grid.': 'Kleinere Flotte → weniger gebundener Kohlenstoff, weniger Elektroschrott, weniger Last fürs Netz.',
      'copy': 'kopieren',
      'fail': 'fehler'
    },
    zh: {
      ...
      'Open the ': '打开 ',
      ', click ': '，点击 ',
      ', and save the downloaded ': '，并保存下载下来的 ',
      '. Your Ed25519 key ': '。你的 Ed25519 密钥 ',
      ...
      'HTTP tunnels get a ': 'HTTP 隧道会得到一个 ',
      '; raw TCP tunnels get ': '；原始 TCP 隧道会得到 ',
      '. Every minute it stays up, you earn ': '。它每多在线一分钟，你就能赚到 ',
      '. List it on the marketplace to earn lease income on top.': '。把它挂到市场里，还能额外获得租赁收入。',
      'What you can do with it': '你可以拿它做什么',
      'No subscriptions. No "free tier" cliffs. Opening a tunnel is free — you\'re billed in credits only for the bytes that actually flow through it, and you earn credits every minute your own devices are serving traffic.':
        '没有订阅费，也没有“免费层”陷阱。开一个隧道本身免费，只有真正经过的字节才会按积分计费；与此同时，只要你的设备在对外提供服务，每分钟都能赚积分。',
      'your device': '你的设备',
      'public traffic': '公网流量',
      'net = earn − charge': '净值 = 收入 − 支出',
      'Uptime reward while your tunnel is online': '隧道在线期间的在线奖励',
      'Earned automatically while your tunnel stays online': '只要隧道保持在线，就会自动赚取',
      'Earned when someone leases your tunnel': '别人租用你的隧道时可赚取',
      ...
      'credit flow': '积分流动',
      'List your spare-device tunnel, set a price per minute, and watch the leases come in. Browse what others offer and rent the right region or hardware for the job.':
        '把你的闲置设备隧道挂出来，设一个按分钟计算的价格，就能开始接单。你也可以看看别人提供什么，按需求租合适的地区或硬件。',
      'Reach any region': '想用哪个地区就用哪个地区',
      'Hosts on the marketplace are spread across home connections in many cities. Rent a node where your users actually are.':
        '市场里的主机分布在很多城市的家庭网络上。你的用户在哪里，就租那里的节点。',
      ...
      'Three logos own most of the public internet. Capacity = a credit card, a console, and a single-vendor lock-in.':
        '公共互联网的大部分容量掌握在少数几个品牌手里。想要容量，就得准备信用卡、控制台账号，以及对单一厂商的依赖。',
      'Always-on fleets that idle most of the day': '全天开机、却大半时间都在空转的机群',
      'Embodied carbon poured into new hardware': '持续投入到新硬件里的隐含碳排',
      'One vendor, one bill, one outage radius': '一个厂商、一张账单、一个共同故障半径',
      '~3 vendors': '约 3 家厂商',
      'tomorrow': '明天',
      'A federated, people-powered cloud': '由用户共同驱动的联邦云',
      'Capacity = whatever\'s plugged in around the world right now. Owned by the people who paid for it, traded peer-to-peer.':
        '容量来自此时此刻世界各地真正插着电的设备。资源归已经买下它的人所有，并且可以点对点交易。',
      'Reuses devices that already exist': '复用已经存在的设备',
      'Capacity scales with how many people show up': '来的人越多，容量就越大',
      ...
      'new servers': '新服务器',
      'No fleet to provision — capacity is hardware that already exists': '不用额外部署机群，容量来自已经存在的硬件',
      'No new fleet to provision; capacity comes from hardware already out there': '不用再部署新机群，容量来自已经在外运行的现有硬件',
      'idle': '空闲',
      'Idle tunnels just sit on an SSH socket; no overhead farm': '空闲隧道只是挂在一个 SSH 连接上，不需要额外的常驻机群',
      'Idle tunnels just sit on an SSH socket; no idle server farm behind them': '空闲隧道只是挂在 SSH 连接上，背后不需要一整群闲置服务器',
      'life': '第二生命',
      'Old laptops, phones, and Pis become useful instead of e-waste': '旧笔记本、手机和树莓派重新派上用场，而不是变成电子垃圾',
      'Old laptops, phones, and Pis go back to work instead of becoming e-waste': '旧笔记本、手机和树莓派重新上岗，而不是变成电子垃圾',
      'Capacity appears when devices are plugged in and disappears when they\'re not.': '设备插上电，容量就出现；设备拔掉电，容量就消失。',
      'Smaller fleet → less embodied carbon, less e-waste, less drain on the grid.': '机群更小 → 隐含碳更低、电子垃圾更少、电网压力更小。',
      'copy': '复制',
      'fail': '失败'
    },
    ja: {
      ...
      'Open the ': 'まず ',
      ', click ': ' を開き、',
      ', and save the downloaded ': ' をクリックして、ダウンロードされた ',
      '. Your Ed25519 key ': ' を保存します。Ed25519 キー ',
      ...
      'HTTP tunnels get a ': 'HTTP トンネルには ',
      '; raw TCP tunnels get ': '、Raw TCP トンネルには ',
      '. Every minute it stays up, you earn ': ' が付きます。動いている 1 分ごとに ',
      '. List it on the marketplace to earn lease income on top.': ' を獲得でき、マーケットプレイスに出せば貸し出し収入も上乗せできます。',
      'What you can do with it': 'これでできること',
      'No subscriptions. No "free tier" cliffs. Opening a tunnel is free — you\'re billed in credits only for the bytes that actually flow through it, and you earn credits every minute your own devices are serving traffic.':
        'サブスクはありません。いわゆる「無料枠の崖」もありません。トンネルを開くのは無料で、実際に流れたバイト分だけクレジットで課金されます。その一方で、自分の機器がトラフィックをさばいているあいだは毎分クレジットを獲得できます。',
      'your device': 'あなたのデバイス',
      'public traffic': '公開トラフィック',
      'net = earn − charge': '差し引き = 収入 − 課金',
      'Uptime reward while your tunnel is online': 'トンネルがオンラインの間にもらえる稼働報酬',
      'Earned automatically while your tunnel stays online': 'トンネルがオンラインのあいだ自動で入る収入',
      'Earned when someone leases your tunnel': '誰かがあなたのトンネルを借りるともらえる収入',
      ...
      'List your spare-device tunnel, set a price per minute, and watch the leases come in. Browse what others offer and rent the right region or hardware for the job.':
        '余っている機器のトンネルを出品し、1 分あたりの料金を決めれば、貸し出しが入ってきます。ほかの人の出品も見て、用途に合った地域やハードウェアを借りられます。',
      'Reach any region': '必要な地域に届く',
      'Hosts on the marketplace are spread across home connections in many cities. Rent a node where your users actually are.':
        'マーケットプレイスのホストは、さまざまな都市の家庭回線に分散しています。ユーザーが本当にいる場所のノードを借りられます。',
      ...
      'Three logos own most of the public internet. Capacity = a credit card, a console, and a single-vendor lock-in.':
        '公開インターネットの大半は、ほんの数社のロゴの向こう側にあります。容量を使うには、クレジットカードと管理画面、そして単一ベンダーへの依存が必要です。',
      'Always-on fleets that idle most of the day': '一日中つけっぱなしで、ほとんどの時間は遊んでいる大規模群',
      'Embodied carbon poured into new hardware': '新しいハードウェアに積み増される埋め込み炭素',
      'One vendor, one bill, one outage radius': '1 社依存、1 枚の請求書、1 つの障害半径',
      '~3 vendors': '約 3 社',
      'tomorrow': 'これから',
      'A federated, people-powered cloud': 'みんなで支えるフェデレーテッドクラウド',
      'Capacity = whatever\'s plugged in around the world right now. Owned by the people who paid for it, traded peer-to-peer.':
        '容量とは、いまこの瞬間に世界のどこかで電源が入っているもの全部です。それを買った人が所有し、そのまま P2P でやり取りできます。',
      'Reuses devices that already exist': 'すでにあるデバイスを使い回せる',
      'Capacity scales with how many people show up': '人が増えるほど容量も増える',
      ...
      'new servers': '新しいサーバー',
      'No fleet to provision — capacity is hardware that already exists': '新しい群を用意しなくてもいい。容量は、すでに存在しているハードウェアです',
      'No new fleet to provision; capacity comes from hardware already out there': '新しい群を増やす必要はなく、容量はすでにそこにあるハードウェアから来ます',
      'idle': '待機中',
      'Idle tunnels just sit on an SSH socket; no overhead farm': '使っていないトンネルは SSH ソケット上で待っているだけ。余計な常駐群は要りません',
      'Idle tunnels just sit on an SSH socket; no idle server farm behind them': 'アイドル状態のトンネルは SSH ソケット上にいるだけで、背後に遊んでいるサーバー群はありません',
      'life': '再活用',
      'Old laptops, phones, and Pis become useful instead of e-waste': '古いノート PC、スマホ、Raspberry Pi が電子ごみではなく戦力になる',
      'Old laptops, phones, and Pis go back to work instead of becoming e-waste': '古いノート PC、スマホ、Raspberry Pi が電子ごみになる代わりに、もう一度働き始めます',
      'Capacity appears when devices are plugged in and disappears when they\'re not.': 'デバイスに電源が入れば容量が現れ、切れば消えます。',
      'Smaller fleet → less embodied carbon, less e-waste, less drain on the grid.': '小さな群で済む → 埋め込み炭素も、電子ごみも、電力網への負荷も減らせます。',
      'copy': 'コピー',
      'fail': '失敗'
    },
    ko: {
      ...
      'Open the ': '먼저 ',
      ', click ': ' 를 열고 ',
      ', and save the downloaded ': ' 를 눌러 내려받은 ',
      '. Your Ed25519 key ': ' 을 저장하세요. Ed25519 키 ',
      ...
      'HTTP tunnels get a ': 'HTTP 터널은 ',
      '; raw TCP tunnels get ': ' 를 받고, raw TCP 터널은 ',
      '. Every minute it stays up, you earn ': ' 를 받습니다. 연결이 살아 있는 매분마다 ',
      '. List it on the marketplace to earn lease income on top.': ' 을 벌고, 마켓플레이스에 올리면 임대 수익도 더할 수 있습니다.',
      'What you can do with it': '이걸로 할 수 있는 일',
      'No subscriptions. No "free tier" cliffs. Opening a tunnel is free — you\'re billed in credits only for the bytes that actually flow through it, and you earn credits every minute your own devices are serving traffic.':
        '구독도 없고, 이른바 "무료 구간 함정"도 없습니다. 터널을 여는 것 자체는 무료이고, 실제로 지나간 바이트에 대해서만 크레딧이 차감됩니다. 반대로 내 기기가 트래픽을 처리하는 동안에는 매분 크레딧을 벌 수 있습니다.',
      'your device': '내 기기',
      'public traffic': '공개 트래픽',
      'net = earn − charge': '순액 = 수익 − 비용',
      'Uptime reward while your tunnel is online': '터널이 온라인일 때 받는 가동 보상',
      'Earned automatically while your tunnel stays online': '터널이 온라인인 동안 자동으로 쌓이는 수익',
      'Earned when someone leases your tunnel': '누군가 내 터널을 임대하면 받는 수익',
      ...
      'credit flow': '크레딧 흐름',
      'List your spare-device tunnel, set a price per minute, and watch the leases come in. Browse what others offer and rent the right region or hardware for the job.':
        '남는 기기의 터널을 올리고 분당 가격을 정하면 임대가 들어옵니다. 다른 사람이 올린 자원도 둘러보고, 필요한 지역이나 하드웨어를 골라 빌릴 수 있습니다.',
      'Reach any region': '원하는 지역까지 닿습니다',
      'Hosts on the marketplace are spread across home connections in many cities. Rent a node where your users actually are.':
        '마켓플레이스의 호스트는 여러 도시의 가정용 회선에 퍼져 있습니다. 실제 사용자와 가까운 지역의 노드를 빌릴 수 있습니다.',
      ...
      'Three logos own most of the public internet. Capacity = a credit card, a console, and a single-vendor lock-in.':
        '공개 인터넷의 대부분은 몇 개 안 되는 로고 뒤에 있습니다. 용량을 쓰려면 신용카드, 관리 콘솔, 그리고 한 업체에 대한 종속이 따라옵니다.',
      'Always-on fleets that idle most of the day': '하루 대부분을 놀리면서도 늘 켜져 있는 대규모 장비군',
      'Embodied carbon poured into new hardware': '새 하드웨어에 계속 쌓이는 내재 탄소',
      'One vendor, one bill, one outage radius': '한 업체, 한 청구서, 한 번에 묶이는 장애 범위',
      '~3 vendors': '약 3개 업체',
      'tomorrow': '앞으로',
      'A federated, people-powered cloud': '사람이 함께 만드는 연합형 클라우드',
      'Capacity = whatever\'s plugged in around the world right now. Owned by the people who paid for it, traded peer-to-peer.':
        '용량은 지금 이 순간 세계 곳곳에서 전원이 연결된 장비 그 자체입니다. 비용을 낸 사람이 소유하고, 사람들끼리 바로 주고받습니다.',
      'Reuses devices that already exist': '이미 있는 기기를 다시 쓴다',
      'Capacity scales with how many people show up': '참여하는 사람이 많아질수록 용량도 커진다',
      ...
      'new servers': '새 서버',
      'No fleet to provision — capacity is hardware that already exists': '새 장비군을 따로 준비할 필요 없습니다. 용량은 이미 있는 하드웨어입니다',
      'No new fleet to provision; capacity comes from hardware already out there': '새 장비군을 더 준비할 필요 없이, 이미 밖에 있는 하드웨어에서 용량이 나옵니다',
      'idle': '유휴',
      'Idle tunnels just sit on an SSH socket; no overhead farm': '유휴 터널은 SSH 소켓 위에 그냥 대기할 뿐이라 별도 상시 장비군이 필요 없습니다',
      'Idle tunnels just sit on an SSH socket; no idle server farm behind them': '유휴 터널은 SSH 소켓 위에 머무를 뿐이고, 뒤에서 놀고 있는 서버팜이 따로 없습니다',
      'life': '재활용 수명',
      'Old laptops, phones, and Pis become useful instead of e-waste': '오래된 노트북, 휴대폰, 라즈베리 파이가 전자폐기물이 아니라 다시 쓸모 있는 장비가 됩니다',
      'Old laptops, phones, and Pis go back to work instead of becoming e-waste': '오래된 노트북, 휴대폰, 라즈베리 파이가 전자폐기물이 되는 대신 다시 일할 수 있게 됩니다',
      'Capacity appears when devices are plugged in and disappears when they\'re not.': '기기를 꽂으면 용량이 생기고, 빼면 사라집니다.',
      'Smaller fleet → less embodied carbon, less e-waste, less drain on the grid.': '더 작은 장비군 → 더 적은 내재 탄소, 더 적은 전자폐기물, 더 적은 전력망 부담.',
      'copy': '복사',
      'fail': '실패'
    }
  };

  Object.keys(LANDING_OVERRIDES).forEach(code => Object.assign(M[code], LANDING_OVERRIDES[code]));
  Object.keys(M).forEach(code => {
    const normalized = {};
    Object.keys(M[code]).forEach(key => {
      normalized[normalizeKey(key)] = M[code][key];
    });
    M[code] = normalized;
  });
  ...
  const PATTERNS = [
    ...
    { rx: /^(\d+) tunnel currently active on this host — running on devices people already owned\.$/, fmt: {
      es: 'Ahora mismo hay {0} túnel activo en este host, corriendo sobre equipos que la gente ya tenía.',
      fr: 'Il y a actuellement {0} tunnel actif sur cet hôte, sur des appareils que les gens avaient déjà.',
      de: 'Aktuell ist {0} Tunnel auf diesem Host aktiv — auf Geräten, die die Leute längst schon hatten.',
      zh: '这台主机当前有 {0} 个活跃隧道，跑在大家本来就拥有的设备上。',
      ja: 'このホストでは現在 {0} 本のトンネルが稼働中で、もともと持っていた機器の上で動いています。',
      ko: '이 호스트에는 지금 활성 터널이 {0}개 있으며, 사람들이 이미 갖고 있던 기기 위에서 돌아가고 있습니다.'
    } },
    { rx: /^(\d+) tunnels currently active on this host — running on devices people already owned\.$/, fmt: {
      es: 'Ahora mismo hay {0} túneles activos en este host, corriendo sobre equipos que la gente ya tenía.',
      fr: 'Il y a actuellement {0} tunnels actifs sur cet hôte, sur des appareils que les gens avaient déjà.',
      de: 'Aktuell sind {0} Tunnel auf diesem Host aktiv — auf Geräten, die die Leute längst schon hatten.',
      zh: '这台主机当前有 {0} 个活跃隧道，跑在大家本来就拥有的设备上。',
      ja: 'このホストでは現在 {0} 本のトンネルが稼働中で、もともと持っていた機器の上で動いています。',
      ko: '이 호스트에는 지금 활성 터널이 {0}개 있으며, 사람들이 이미 갖고 있던 기기 위에서 돌아가고 있습니다.'
    } },
  ...
  function setLocale(code) {
    ...
    updateAllPickers();
    try {
      document.dispatchEvent(new CustomEvent('airweb:locale-changed', { detail: { locale: code } }));
    } catch (e) {}
  }
